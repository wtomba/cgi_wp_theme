<?php
  ...
  add_filter('single_template', create_function(
    ...
    'foreach( (array) get_the_category() as $cat ) {
      if ($cat->category_parent) {
        ...
        $ancestor = get_category($ancestors[0]);

        return TEMPLATEPATH . "/single-{$ancestor->slug}.php";
      }
  ...
  // Gets the top most ancestor of the current post
  ...
  function cgi_breadcrumbs() {  
    ...
    if (is_home() || is_front_page()) {  
      ...
      if ($show_on_home == 1) echo '<div class="cgiBreadcrumbs"><a href="' . $home_link . '">' . $text['home'] . '</a></div>';  
    
    } else {  
    
      echo '<div class="cgiBreadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">';  
      if ($show_home_link == 1) {  
